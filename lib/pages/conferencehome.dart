...
class ClassConference extends StatefulWidget {
  @override
  _ClassConferenceState createState() => _ClassConferenceState();
}
class _ClassConferenceState extends State<ClassConference> {
